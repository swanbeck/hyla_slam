...
#include "hyla_genz/hyla_genz.hpp"
#include "hyla_genz/kiss_icp_utils.hpp"
#include "hylacomylus/hylacomylus.hpp"
#include "hylacomylus/types.hpp"
#include "hylacomylus/utils.hpp"

#include "hyla_slam_genz_parameters.hpp"
...
private:
    ...
    std::unique_ptr<hyla_genz::HylaGenz> localizer_;

    std::shared_ptr<hyla_slam_genz::ParamListener> param_listener_;
    hyla_slam_genz::Params params_;

    hylacomylus::MappingConfig mapping_config_;
    hyla_genz::GenzConfig localization_config_;
