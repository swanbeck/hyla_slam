...
class IndexData : public BT::StatefulActionNode
{
public:
    using Trigger = hyla_slam_interfaces::srv::IndexData;

    IndexData(const std::string name, const BT::NodeConfig &config);
